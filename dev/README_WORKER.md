...
Once registered with [QOR Admin](http://github.com/driver005/commerce/admin), [Worker](https://github.com/driver005/commerce/worker) will provide a `Workers` section in the navigation tree, containing pages for listing and managing the following aspects of Workers:
...
[![GoDoc](https://godoc.org/github.com/driver005/commerce/worker?status.svg)](https://godoc.org/github.com/driver005/commerce/worker)

## Usage

```go
import "github.com/driver005/commerce/worker"
