...
Audited is used to record the last User who created and/or updated your [GORM](https://github.com/jinzhu/gorm) model. It does so using a `CreatedBy` and `UpdatedBy` field. While Audited can be used alone (with [GORM](https://github.com/jinzhu/gorm)), it integrates nicely with [QOR](https://github.com/driver005/commerce/qor) to log and display this extra information.

[![GoDoc](https://godoc.org/github.com/driver005/commerce/audited?status.svg)](https://godoc.org/github.com/driver005/commerce/audited)
...
import (
  ...
  "github.com/driver005/commerce/audited"
)
...
```go
import "github.com/driver005/commerce/audited"
