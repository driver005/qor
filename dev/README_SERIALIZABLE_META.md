...
[![GoDoc](https://godoc.org/github.com/driver005/commerce/serializable_meta?status.svg)](https://godoc.org/github.com/driver005/commerce/serializable_meta)

## Usage

The example herein shows how to manage different kinds of background jobs using https://github.com/driver005/commerce/serializable_meta.
...
Add function `GetSerializableArgumentResource` to the model, so [Serializable Meta](https://github.com/driver005/commerce/serializable_meta) can know the type of argument. Then define background jobs.
