...
[![GoDoc](https://godoc.org/github.com/driver005/commerce/media?status.svg)](https://godoc.org/github.com/driver005/commerce/media)
...
Then add [OSS(Object Storage Service)](https://github.com/driver005/commerce/oss) to your model:
...
The [OSS(Object Storage Service)](https://github.com/driver005/commerce/oss) provides a pretty simple API to operate files on filesytem or cloud storage
...
"github.com/driver005/commerce/media/oss"
"github.com/oss/s3"
"github.com/driver005/commerce/media/media_library"
)
...
To avoid this problem, we made a safer `FileServer` function [here](https://github.com/driver005/commerce/qor/blob/master/utils/utils.go#L176). This function serves file only. So the previous code now turned into:
