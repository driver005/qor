...
import (
	...
	qorrender "github.com/driver005/commerce/render"
	"github.com/driver005/commerce/responder"
...
func (ctrl Controller) CompleteCreditCard(w http.ResponseWriter, req *http.Request) {
	...
	if creditCard.ValidNumber() {
		// TODO integrate with https://github.com/driver005/commerce/gomerchant to handle those information
		tx := utils.GetDB(req)
		err := orders.OrderState.Trigger("checkout", order, tx, "")
